...
<div class="lockscreen-wrapper">
  ...
  <!-- User name -->
  <div class="lockscreen-name">Presensi Kehadiran!</div>
  ...
  <div class="lockscreen-item">
    ...
    <form action="action_admin/kehadiran.php" class="lockscreen-credentials" method="POST">
      ...
      <div class="input-group">
        <input type="text" name="nik" class="form-control" placeholder="Masukkan NISN">
  ...
  <div class="help-block text-center">
    Masukkan NISN anda sebagai tanda kehadiran
  </div>
  <div class="lockscreen-footer text-center">
    <b>SMK Negeri 1 Nglegok</b>
  </div>
</div>
<!-- /.center -->
